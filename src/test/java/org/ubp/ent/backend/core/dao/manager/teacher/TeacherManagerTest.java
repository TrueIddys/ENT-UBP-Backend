...
public class TeacherManagerTest extends WebApplicationTest {
    ...
    public void shouldFailAddEmailWithNonExistingTeacher() {
        ...
        teacherManager.addEmail(12L, EmailTest.createOne(type));
    }
    ...
    public void shouldFailAddEmailWithEmailHavingNonExistingType() {
        Teacher model = scenarioHelper.createEmptyTeacher();
        teacherManager.addEmail(model.getId(), EmailTest.createOne());
    }
    ...
    public void shouldFailAddPhoneWithNonExistingTeacher() {
        ...
        teacherManager.addPhone(12L, PhoneTest.createOne(type));
    }
    ...
    public void shouldFailAddPhoneWithPhoneHavingNonExistingType() {
        Teacher model = scenarioHelper.createEmptyTeacher();
        teacherManager.addPhone(model.getId(), PhoneTest.createOne());
    }
